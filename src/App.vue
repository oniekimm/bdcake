<template>
  <div class="body" ref="body">
    ...
    <!-- <h2 class="title-top">happy birthday</h2> -->

    <h1 class="title-bottom">robert</h1>
    <!-- <p ref="logo" style="opacity: 0">i love u</p> -->

    <div ref="logo" class="lightOn" style="opacity: 1">
      <div class="text1">
        <img
          src="tex/letter1.png"
...
body {
  ...
  margin: 0;
  padding: 0;
  background: radial-gradient(circle, #9f8686, transparent 50%),
...
.body {
  ...
  margin: 0;
  padding: 0;
  background: radial-gradient(circle, transparent, rgba(0, 0, 0, 1), black 68%);
  // background: radial-gradient(circle, #9f8686, transparent 68%);
...
h1 {
  ...
  font-size: 100px;
  line-height: 100px;
  background: -webkit-linear-gradient(#eee, #735f5f, #eee);
  //   url(data:image/png;base64,);
